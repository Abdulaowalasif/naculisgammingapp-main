...
import 'package:naculisgammingapp/core/const/demo_data.dart';
import 'package:naculisgammingapp/feature/profile_set_up/widget/selected_btn.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Image.asset(
          'assets/images/setup_progress/2.png',
        ),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
              ...
              itemCount: DemoData.setupData['vibe']?.length ?? 0,
              itemBuilder: (context, index) {
                final vibe = DemoData.setupData['vibe']![index];
                return Padding(
