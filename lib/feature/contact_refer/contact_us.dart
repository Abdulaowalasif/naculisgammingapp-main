...
class ContactUs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ProfileAppBar(title: AppStringEn.contactUs.tr),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            customInputField(AppStringEn.titleHint.tr, context),
            ...
            const SizedBox(height: 6),
            customInputField(AppStringEn.messageHint.tr, context, maxLines: 5),

            const SizedBox(height: 30), // acts as a spacer for keyboard
              ...
              child: Padding(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF36BA17),
