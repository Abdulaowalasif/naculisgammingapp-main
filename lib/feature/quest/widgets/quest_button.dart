...
class QuestButton extends StatelessWidget {
  ...
  const QuestButton({
    super.key,
    required this.title,
    required this.onTap,  required this.iconAsset,
...
class QuestCard extends StatelessWidget {
  ...
  const QuestCard({
    ...
    required this.onTap,
    this.backgroundColor = const Color(0xFF36BA17),
  });
...
class QuestProgressCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final double percent = totalProgress == 0
        ? 0
        : (currentProgress / totalProgress).clamp(0, 1).toDouble();
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Progress $currentProgress/$totalProgress",
          ...
          Stack(
            children: [
              ...
              Container(
                height: 10,
                width: MediaQuery.of(context).size.width * percent * 0.85,
                decoration: BoxDecoration(
                  color: Colors.orange,
                  borderRadius: BorderRadius.circular(10),
                ),
        ...
        children: [
          ...
          Padding(
            ...
            child: _buildRow(
              ...
              value: (showLevel ? totalLesson : completedLesson ?? 6).toString().padLeft(2, '0'),
            ),
          ),
